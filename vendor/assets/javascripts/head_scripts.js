...
function showSuccessToast(text) {
    jQuery().toastmessage("showSuccessToast", text)
}
...
function showNoticeToast(text) {
    jQuery().toastmessage("showNoticeToast", text)
}
...
function showWarningToast(text) {
    jQuery().toastmessage("showWarningToast", text)
}
...
function showErrorToast(text) {
    jQuery().toastmessage("showErrorToast", text)
}
